...
async function handleMessage(event) {
  ...
  if (messageText.includes("prebook") || messageText.includes("pre-book") || messageText.includes("pre book")) { return; }
  let reply = "";
  ...
  if (reply) { await sendMessage(senderId, reply, PAGE_ACCESS_TOKEN); }
}

function isGreeting(text) {
  const greetings = ["hello", "hi", "hey", "assalamu", "salam", "good morning", "good evening", "good afternoon", "hlo", "hlw"];
